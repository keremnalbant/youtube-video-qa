...
class Config:
    ...
    LLM_MODEL_ID: str = os.getenv("LLM_MODEL_ID", "eu.anthropic.claude-3-5-sonnet-20240620-v1:0")
    ...
    def __post_init__(self):
        required_vars = ["WEAVIATE_URL", "WEAVIATE_AUTH_KEY", "AWS_ACCESS_KEY", "AWS_SECRET_KEY"]
